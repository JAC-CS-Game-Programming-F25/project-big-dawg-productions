import { CANVAS_WIDTH, UI_COLOR, UI_FONT_SIZE, UI_HIGHLIGHT_COLOR, UI_FONT_FAMILY, SPECIAL_FONT_FAMILY } from '../globals.js';
...
export default class MilestoneNotifier {
    ...
    render(ctx) {
        ...
        ctx.font = `${UI_FONT_SIZE}px ${SPECIAL_FONT_FAMILY}`;
