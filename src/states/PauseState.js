...
import { CANVAS_WIDTH, CANVAS_HEIGHT, UI_COLOR, UI_LARGE_FONT_SIZE, UI_FONT_SIZE, UI_HIGHLIGHT_COLOR, stateMachine, input, KEYS, COLORS } from '../globals.js';
...
export default class PauseState extends BaseState {
    ...
    render(ctx) {
        ...
        // Instructions
        ctx.fillStyle = UI_COLOR;
        ctx.font = `${UI_FONT_SIZE * 0.8}px Arial`;
